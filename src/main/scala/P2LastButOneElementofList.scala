 ...
 */
  ...
  */
  ...
  /*
  Pattern guards are simply conditional expressions that rule the application of a pattern.
  They are boolean expressions which are used to make cases more specific.
